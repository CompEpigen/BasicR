---
title: "Distributions and Associations"
...
Load the __tidyverse__ libraries. And load the murders dataset from the dslabs package.
...
1\. Load the __tidyverse__ libraries. And load the murders dataset from the dslabs package.

2\. Make a histogram of the population
