...
The current directory should be `/BasicR/markdown` If you need to change your working directory, you can use the function `setwd`
...
Use `../` for the parent (`/BasicsR`) directory, and then access the `inst/extdata` folder.
