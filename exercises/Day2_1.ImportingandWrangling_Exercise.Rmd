...
The current directory should be `/BasicR/exercises` If you need to change your working directory to `/BasicR`, you can use the function `setwd`
...
Use `../` for the parent (`/BasicsR`) directory, and then access the `data` folder.
